        ...
        public override string ToString()
        {
            ...
            switch (Format)
            {
                ...
                case SecsFormat.JIS8:
                    ...
                    sb.Append("<A ").Append(Unsafe.As<string>(_values).Length).Append(" ").Append(Unsafe.As<string>(_values)).Append(">").AppendLine();
                    
                    break;
                case SecsFormat.Binary:
                    sb.Append("<B[").Append(Unsafe.As<byte[]>(_values).Length).Append("] ").Append(Unsafe.As<byte[]>(_values).ToHexString()).Append(">").AppendLine();
                    break;
                default:
